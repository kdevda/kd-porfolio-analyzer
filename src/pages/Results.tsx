          ...
          <div className="h-fit mb-8">
            <BlurBackground className="p-4 md:p-6 h-[468px] overflow-auto shadow-lg rounded-lg">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="p-3 md:p-4 rounded-lg shadow-sm bg-white border border-gray-100">
              ...
              {dcaInsight && (
                <div className="p-3 md:p-4 rounded-lg shadow-sm bg-white border border-gray-100 my-3">
                  <div className="flex items-start gap-2">
              ...
              {projections && (
                <div className="mt-4">
                  <h3 className="text-sm font-medium mb-3 text-gray-800 flex items-center gap-2">
                    <Award className="h-4 w-4 text-emerald-600" />
                    Future Projections
                  </h3>
                  <div className="grid grid-cols-3 gap-3">
                    {projections.map((projection, index) => (
                      <div key={index} className="p-3 md:p-4 rounded-lg shadow-sm bg-white border border-gray-100">
                        <div>
